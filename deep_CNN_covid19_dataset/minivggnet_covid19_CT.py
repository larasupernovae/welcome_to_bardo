...
from utilities.nn.cnn import MiniVGGNet_3
...
# ADAM optimizer
model = MiniVGGNet_3.build(width=32, height=32, depth=3, classes=len(classNames))
...
# $ python minivggnet_covid19_CT_3.py --dataset covid19_CT_images --model covid19_CT_weights_3.hdf5