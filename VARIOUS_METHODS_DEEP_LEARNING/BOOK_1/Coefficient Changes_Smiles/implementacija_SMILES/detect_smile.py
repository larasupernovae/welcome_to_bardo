...
# COMMAND PROMPT
# $ cd \Users\jopas\OneDrive\Desktop\DEEP_LEARNING_CNN\VARIOUS METHODS\Coefficient Changes_Smiles\implementacija_SMILES
# $ python detect_smile.py --cascade haarcascade_frontalface_default.xml --model lenet.hdf5