...
# COMMAND PROMPT
# $ cd \Users\jopas\OneDrive\Desktop\6 Deep Learning for Computer Vision Adrian Rosebrock\Chapter16
# $ python cifar10_lr_decay.py --output output/cifar-10-python.tar