...
# layers- a list of integers that represent the architecture of the neaural network
# [2,2,1] - exmpl. first layer 2 nodes, hidden 2 nodes, and 1 node output layer
# alpha - learning rate
class NeuralNetwork:
    def __init__(self, layers, alpha=0.1):
        ...
        for i in np.arange(0, len(layers) - 2):
            ...
            # adding an extra node for the bias - MxN
...
# X - training data
# y - class label coresponding to each entry X
# display_update - how many N epochs we will print to terminal
...
# y - the correspondind class label
    def fit_partial(self, x, y):
        ...
        # Loop over the layers in reverse order (ignoring the last 2 layers - they are accounted for in the code above D)
