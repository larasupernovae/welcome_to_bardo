...
# COMMAND PROMPT
# $ cd \Users\jopas\OneDrive\Desktop\DOKTORSKE\MASTER RAD\6 Deep Learning for Computer Vision Adrian Rosebrock\Chapter13
# $ python shallownet_load.py --dataset animals --model shallownet_weights.hdf5