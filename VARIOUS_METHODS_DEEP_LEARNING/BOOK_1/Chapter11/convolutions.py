...
# standard numerical array processing
import numpy as np
import argparse
...
def convolve(image, kernel):
    ...
    for y in np.arange(pad, img_h + pad):
        for x in np.arange(pad, img_w + pad):
            ...
            # dimensions - SAME SIZE AS THE KERNAL - region of intrest
...
# $ cd \Users\jopas\OneDrive\Desktop\6 Deep Learning for Computer Vision Adrian Rosebrock\Chapter11
