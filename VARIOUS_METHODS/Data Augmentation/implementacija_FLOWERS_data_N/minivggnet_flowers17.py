...
plt.title("Training Loss and Accuracy on Flowers-17 (without data augmentation")
plt.xlabel("Epoch #")
...
# COMMAND PROMPT
# $ cd \Users\jopas\OneDrive\Desktop\DEEP_LEARNING_CNN\VARIOUS METHODS\Data Augmentation\implementacija_FLOWERS_data_N
