...
# COMMAND PROMPT
# $ cd \Users\jopas\OneDrive\Desktop\DEEP_LEARNING_CNN\VARIOUS METHODS\Feature Extractors\implementacija_ANIMALS_FE
# $ python extract_features.py --dataset animals --output features.hdf5